...
The two graphs in figure nnn on the left side show the number of trees planted per year as of 1950. The graph on the left side reflects our data on a yearly basis as we got it from our data set. From the data we gathered that a large number of trees were planted in five-year cycles in the nineties and earlier. To gain a more consistent view, we binned the trees into ten-year periods in the middle bar chart.
...
A first visual inspection of carbon monoxide and nitrogen oxides as illustrated in figure nnn shows a reduction of both CO and NOx, from 1983 up to 2022. The trend line in red shows a significant improvement, especially in the Eighties and early Nineties. 
